...
% Prepare derived/measured data for saving
C_n2e = C_ECEF_to_NED';
...
result_struct = struct('gnss_pos_ned', gnss_pos_ned, 'acc_biases', acc_biases, ...
                ...
                'gnss_time', gnss_time, 'imu_time', t_imu, ...
                'gnss_pos_ecef', gnss_pos_ecef, 'gnss_vel_ecef', gnss_vel_ecef, ...
                ...
                'imu_pos_ned', pos_integ, 'imu_vel_ned', vel_integ, ...
                'imu_acc_ned', acc_integ, 'imu_pos_ecef', imu_pos_ecef, ...
                'imu_vel_ecef', imu_vel_ecef, 'imu_acc_ecef', imu_acc_ecef);
