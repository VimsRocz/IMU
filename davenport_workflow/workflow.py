...
3. Solve Wahba's problem using Davenport's Q-Method to
...
print("\nRotation quaternion (body to NED) using Davenport:")
print(q_dav)
# GNSS to NED
...
bias_acc = static_acc + (R_dav.T @ g_NED)
bias_gyro = static_gyro - (R_dav.T @ omega_ie_NED)
acc_body -= bias_acc
gyro_body -= bias_gyro
