# flake8: noqa
"""SVD-based IMU/GNSS processing demonstration.
...
3. Solve Wahba's problem using the SVD method to
...
print("\nRotation quaternion (body to NED) using SVD:")
print(q_svd)
# ---------------------------------------------------------------------
...
bias_acc = static_acc + (R_svd.T @ g_NED)
bias_gyro = static_gyro - (R_svd.T @ omega_ie_NED)
acc_body -= bias_acc
gyro_body -= bias_gyro
