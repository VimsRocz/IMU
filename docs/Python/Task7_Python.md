...
### 7.3 Plot Residuals
- Save `<tag>_task7_3_residuals_position_velocity.png` and an error norm plot in the same folder.
...
- Write `<tag>_task7_4_attitude_angles_euler.png` with roll, pitch and yaw over time.

### 7.5 Truth – Fused Difference
- If the reference trajectory is provided, plot component-wise differences.
- Figures are saved as `<tag>_task7_5_diff_truth_fused_over_time_<frame>.png` for
