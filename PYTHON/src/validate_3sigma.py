...
def main() -> None:
    ...
    for i, lab in enumerate(labels_pos):
        ...
        save_matlab_fig(fig, str((out_dir / f"pos_err_{lab}").with_suffix('')))
        plt.close(fig)
    ...
    for i, lab in enumerate(labels_vel):
        ...
        ax.legend()
        fig.tight_layout()
        save_matlab_fig(fig, str((out_dir / f"vel_err_{lab}").with_suffix('')))
        plt.close(fig)
    ...
    for i, lab in enumerate(labels_quat):
        ...
        ax.legend()
        fig.tight_layout()
        save_matlab_fig(fig, str((out_dir / f"quat_err_{lab}").with_suffix('')))
        plt.close(fig)
